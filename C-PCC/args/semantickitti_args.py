...
def parse_semantickitti_args():
    ...
    # dataset
    # parser.add_argument('--train_data_path', default='./data/semantickitti_test/semantickitti_train_cube_size_12.pkl', type=str, help='path to train dataset')
    # parser.add_argument('--train_cube_size', default=12, type=int, help='cube size of train dataset')
    # parser.add_argument('--val_data_path', default='./data/semantickitti_test/semantickitti_val_cube_size_12.pkl', type=str, help='path to val dataset')
    # parser.add_argument('--val_cube_size', default=12, type=int, help='cube size of val dataset')
    # parser.add_argument('--test_data_path', default='./data/semantickitti_test/semantickitti_test_cube_size_12.pkl', type=str, help='path to test dataset')

    parser.add_argument('--train_data_path', default='/hy-tmp/data/semantickitti/semantickitti_train_cube_size_12.pkl',
                        type=str, help='path to train dataset')
    parser.add_argument('--train_cube_size', default=12, type=int, help='cube size of train dataset')
    parser.add_argument('--val_data_path', default='/hy-tmp/data/semantickitti/semantickitti_val_cube_size_12.pkl',
                        type=str, help='path to val dataset')
    parser.add_argument('--val_cube_size', default=12, type=int, help='cube size of val dataset')
    ...
    parser.add_argument('--test_data_path', default='/hy-tmp/data/semantickitti/semantickitti_test_cube_size_12.pkl',
    ...
    parser.add_argument('--dim_head', default=64, type=int, help='dim_head')
    parser.add_argument('--dropout', default=0., type=float, help='dropout = ')
    parser.add_argument('--step_size', default=0.1, type=float, help='step_size ')
    parser.add_argument('--lambd', default=0.1, type=float, help='lambd')
