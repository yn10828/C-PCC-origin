...
def test_xyzs(args):
    ...
    with torch.no_grad():
        for i, input_dict in enumerate(test_loader):
            ...
            # normals : (b, n, c)
            gt_normals = input_dict['normals'].to(device)
            # (b, c, n)
...
def parse_test_args():
    ...
    parser.add_argument('--model_path', default='output/result_retrain/2023-10-09T21:16:36.727015/ckpt/ckpt-best.pth', type=str, help='path to ckpt')
    ...
    # parser.add_argument('--runname', type=str, default='sem824_01')
...
if __name__ == "__main__":
    ...
    if model_args.use_wandb:
        ...
        import wandb
        wandb.init(config=model_args, project='C-PCC-Ablation-test', name='CRATE+3-3-3', dir=model_args.wandb_dir)
